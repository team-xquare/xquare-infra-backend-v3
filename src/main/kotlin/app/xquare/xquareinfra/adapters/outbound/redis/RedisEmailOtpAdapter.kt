...
class RedisEmailOtpAdapter (
    ...
    override fun saveOtp(email: String, otp: String, ttlSeconds: Long){
    ...
    override fun saveVerifiedToken(token: String, email: String, ttlSeconds: Long) {
    ...
    override fun getEmailByVerifiedToken(token: String): String? =
        redisTemplate.opsForValue().get("verified$token")

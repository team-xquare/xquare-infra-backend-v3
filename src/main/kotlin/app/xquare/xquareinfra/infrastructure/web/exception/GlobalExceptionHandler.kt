...
import app.xquare.xquareinfra.adapters.inbound.web.addon.errorCode.AddonExceptionMapper
...
import app.xquare.xquareinfra.adapters.inbound.web.user.errorCode.UserExceptionMapper
...
class GlobalExceptionHandler : ResponseEntityExceptionHandler() {
    ...
    private fun mapUseCaseExceptionToResponseEntity(ex: UseCaseException): ResponseEntity<Any> =
        when (ex) {
            ...
            is UserException -> UserExceptionMapper.toResponseEntity(ex)
